...
// RESOLUCAO COM ENCADEAMENTO DE REDUCES
...
// RESOLUCAO COM ENCADEAMENTO DE REDUCES EM 1 LINHA
const containsA = names.reduce((acc, nome) => acc + nome.split('').reduce((cont, letra) => (letra === 'A' || letra === 'a') ? cont += 1 : cont, 0), 0)
